...
![The two geospatial data models represent two views of the real world: the discrete object (vector) view and the continuous field (raster) view ](/figures/ch2/datamodel.png){#fig-datamodel}
...
![Raster data can be used to represent discrete (a) and continuous (b & c) phenomenon. a: land cover type in Nebraska. b: Digital elevation model (DEM) for Indian Cave State Park. c: map of air temperature. DEM data was obtained from the USGS 3D Elevation Program. ](/figures/ch2/rastertype.png){#fig-rastertype}
